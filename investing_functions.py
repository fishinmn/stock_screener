...
def df_filter_fundamentals_with_earnings(df):
    """
    Main function to filter and score stocks based on fundamental metrics.
    Used by: all fundamentals_screener_*.py files
    ...
    df = df[['date','symbol','epsActual','epsEstimated','revenueActual','revenueEstimated', 'Symbol', 'longName', 'sector','industry','industryKey', 'marketCap', 'priceToSalesTrailing12Months', 'currentRatio', 'quickRatio', 'revenueGrowth', 'grossMargins', 'trailingPE', 'forwardPE', 'PS_adj', 'pegRatio', 'dividendYield', 'earningsGrowth', 'profitMargins',  'shortPercentOfFloat', 'roe', 'score']]
    return df
