...
filepath = os.path.join(dir_path, 'data', 'nasdaq_screener_smallcap_with_coverage.csv')#.csv
...
#print (df[['Symbol', 'score']])
#dictionary = pd.DataFrame.from_records(outputdata)
filepath = os.path.join(dir_path, 'data', 'fundamentals_screener_small_cap.csv')
