...
#filepath = os.path.join(dir_path, 'nasdaq_screener_lrgcap.csv')#.csv
filepath = os.path.join(dir_path, 'data', 'nasdaq_screener_megacap.csv')#.csv
...
df_with_score = df_with_score[['Symbol', 'longName', 'sector', 'industry', 'industryKey', 'marketCap', 'priceToSalesTrailing12Months', 'currentRatio', 'quickRatio', 'revenueGrowth', 'grossMargins', 'trailingPE', 'forwardPE', 'PS_adj', 'pegRatio', 'dividendYield', 'earningsGrowth', 'profitMargins',  'shortPercentOfFloat', 'roe', 'score']]

filepath = os.path.join(dir_path, 'data', 'fundamentals_screener_mega_caps.csv')
